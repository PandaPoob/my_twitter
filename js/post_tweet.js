async function handleSubmitTweet() {
  ...
  >
    <a
      href="/{{tweet['user_name']}}/status/{{tweet['tweet_slug']}}"
    ...
    >
      ...
      <div class="w-full pr-4">
        ...
        <div>
          ...
          <p class="text-base mt-1 mb-2">{{tweet["tweet_field_text"]}}</p>
          % end
          <!-- tweet image display-->
          <div class="mt-3">
            ...
            <img
              ...
              src="/images/tweet_imgs/{{images['tweet_image_url']}}"
            />
            % end
          </div>
          % elif len(tweet["tweet_images"]) == 2:
          ...
          % elif len(tweet["tweet_images"]) == 3:
          <div class="flex gap-0.5 mt-3">
            <div class="w-[50%]">
              <img
                class="rounded-xl w-full h-full object-cover"
                alt="{{tweet['user_full_name']}} tweet image"
                src="/images/tweet_imgs/{{tweet['tweet_images'][0]['tweet_image_url']}}"
              />
            </div>
            <div class="w-[50%] flex flex-col gap-0.5">
              <img
                class="rounded-xl w-full h-full object-cover"
                alt="{{tweet['user_full_name']}} tweet image"
                src="/images/tweet_imgs/{{tweet['tweet_images'][1]['tweet_image_url']}}"
              />
              <img
                class="rounded-xl w-full h-full object-cover"
                alt="{{tweet['user_full_name']}} tweet image"
                src="/images/tweet_imgs/{{tweet['tweet_images'][2]['tweet_image_url']}}"
              />
            </div>
          </div>
          % elif len(tweet["tweet_images"]) == 4:
        ...
        >
          <button class="group flex items-center gap-1 hover:text-twitterblue">
            ...
            % if tweet["tweet_total_replies"] != 0:
          ...
          <button class="group flex items-center gap-1 hover:text-green-500">
            ...
            % if tweet["tweet_total_retweets"] != 0:
...
function getAccountStatus() {
  const accountStatus = "twitterBlue"; //twitterGold, "Basic"
