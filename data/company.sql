...
WHERE user_id = "1"
AND products.product_price < 15;

SELECT SUM(product_price) FROM products
SELECT product_price FROM products WHERE product_name LIKE "%b%";
SELECT AVG(product_price) FROM products;

---------TRIGGER---------
--trigger
--INSERT UPDATE DELETE
--Time events: BEFORE & AFTER
-- AFTER on INSERT
...
INSERT INTO tweets VALUES("4", "Hi again", "1");
SELECT * FROM tweets;
